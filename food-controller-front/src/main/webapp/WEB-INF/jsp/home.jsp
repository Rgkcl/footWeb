...
<div class="memwrap wrap clearfix">
  <div class="section fl">
    <div class="location tr"><a href="home" class="current">首页</a><a href="#">我的饭局</a><a href="follow">我的关注</a><a href="My_Messages">我的留言</a></div>
          ...
          <li class="np-post">
            ...
            <div class="post-body">
              <div class="post-header clearfix">
                <a href="home" class="name">大郭郭呐</a>发布了  no.01期活动
              </div>
