...
$(function(){
	...
	if(is_login=="is"){
		$("#displayName").html("<a href='mem'>个人中心</a><a href='exit'>退出登陆</a>");
	}
});
</script>
  <div class="indexban" style="background:url(images/img1.jpg);">
    <div class="wrap">
      <a href="index" class="logo indent">logo</a>
      <div class="medium-right" id="displayName"><a href="#">发布我的饭局</a><a href='login'>登陆</a><a href='reg'>注册</a></div>
    ...
    <div class="p1-hero-search-form">
      <div class="wrap clearfix">
        ...
        <div class="hot-key fl">热门搜索： <a href="active">早餐</a><a href="active">午餐</a><a href="active">晚餐</a><a href="active">西餐</a><a href="active">午餐</a><a href="active">西餐</a><a href="active">西餐</a></div>
      </div>
    </div>
  </div>
  
  <div class="wrap">
    <div class="row-space tc"><a href="active"><img src="images/txt1.png"></a></div>
