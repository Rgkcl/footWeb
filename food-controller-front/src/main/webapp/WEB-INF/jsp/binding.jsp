...
<div class="memwrap wrap clearfix">
  <div class="section fl">
    <div class="location tr"><a href="mem">基本资料</a><a href="pwd">修改密码</a><a href="binding" class="current">手机绑定</a></div>
    <div class="pd20">
      <table class="baseinfo">
        <tr>
          <td>
            <div class="icoimg"><img src="images/img6.jpg"></div>
            <div class="infotxt">你的手机号码：${ binding}<p class="mt10"><a href="Phone" class="button btn-bind">立即去绑定</a></p></div>
          </td>
        </tr>
