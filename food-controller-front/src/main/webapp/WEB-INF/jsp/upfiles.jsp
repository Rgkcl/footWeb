...
<body>
  <form action="upPicture" method="post">
  <div class="upfiles">
    ...
    <div class="controlbox tc"><button type="submit" value="" name="" class="button btn-save">保存</button><button type="button" value="" name="" class="button btn-reset">取消</button></div>
  </div>
  </form>
