...
<div class="memwrap wrap clearfix">
  <div class="section fl">
    <div class="location tr"><a href="mem">基本资料</a><a href="pwd" class="current">修改密码</a><a href="binding">手机绑定</a></div>
    <form action="updatePass" method="post">
    <div class="pd20">
      <table class="baseinfo">
        <tr>
          <th>原始密码：</th>
          <td><input type="password" name="password1" class="baseipt"></td>
        </tr>
        <tr>
          <th>新密码：</th>
          <td><input type="password" name="password2" class="baseipt"></td>
        </tr>
        <tr>
          <th>确认密码：</th>
          <td><input type="password" name="password3" class="baseipt"></td>
        </tr>
        <tr>
          <th>&nbsp;</th>
          <td><button type="submit" name="save" value="" class="button btn-save">修改</button></td>
        </tr>
      </table>
    </div>
    </form>
