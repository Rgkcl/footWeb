...
<div class="memwrap wrap clearfix">
  <div class="section fl">
    <div class="location tr"><a href="mem">基本资料</a><a href="pwd">修改密码</a><a href="binding" class="current">帐号绑定</a></div>
    <div class="pd20">
      <table class="baseinfo">
        <tr>
          <td width="50%">
            <div class="icoimg"><img src="images/img5.jpg"></div>
            <div class="infotxt">你的邮箱帐号：未绑定<p class="mt10"><a href="Email-binding" class="button btn-bind">立即去绑定</a></p></div>
          </td>
          <td>
            <div class="icoimg"><img src="images/img6.jpg"></div>
            <div class="infotxt">你的手机号码：未绑定<p class="mt10"><a href="Phone" class="button btn-bind">立即去绑定</a></p></div>
          </td>
        </tr>
        <tr>
          <td>
            <div class="icoimg"><img src="images/img7.jpg"></div>
            <div class="infotxt">实名认证：未认证<p class="mt10"><a href="Verified" class="button btn-bind">立即去认证</a></p></div>
          </td>
          <td></td>
        </tr>
      </table>
