...
<div class="memwrap wrap clearfix">
  <div class="section fl">
    <div class="location tr"><a href="Message" class="current">私信</a><a href="Message"> 未读消息 <span class="num">7</span></a><a href="Message">全部消息</a></div>
          ...
          <li class="np-post">
            ...
            <div class="post-body">
              <div class="post-header clearfix">
                <a href="home" class="name o">兜帽家的豆豆</a><span class="time">01月20日 11:11</span><span class="reply"><em class="myfont">&#xe640;</em><a href="javascript:;"> 回复</a></span>
              </div>
